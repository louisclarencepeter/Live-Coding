...
var me = "style[".concat(f, "][").concat("data-styled-version", '="').concat("6.0.0-rc.6", '"]');
...
var we = function(e) {
  ...
  o2.setAttribute(f, "active"), o2.setAttribute("data-styled-version", "6.0.0-rc.6");
  var i2 = Se();
...
function Qe(e, r2, s2) {
  var i2 = ee(e), a2 = e, c2 = !M(e), p2 = r2.attrs, d = void 0 === p2 ? E : p2, h = r2.componentId, f2 = void 0 === h ? function(e2, t) {
    ...
    Ze[n] = (Ze[n] || 0) + 1;
    var o2 = "".concat(n, "-").concat(x("6.0.0-rc.6" + n + Ze[n]));
  ...
  function D2(e2, r3) {
    return function(e3, r4, s3, i3) {
      var a3 = e3.attrs, c3 = e3.componentStyle, p3 = e3.defaultProps, d2 = e3.foldedComponentIds, h2 = e3.styledComponentId, f3 = e3.target, m3 = import_react.default.useContext(He), y3 = Ve(), v3 = e3.shouldForwardProp || y3.shouldForwardProp;
      (0, import_react.useDebugValue)(h2);
      ...
      }(a3, r4, P(r4, m3, p3) || N), S3 = g3.as || f3, w3 = {};
      for (var b2 in g3)
        void 0 === g3[b2] || "$" === b2[0] || "as" === b2 || "theme" === b2 || ("forwardedAs" === b2 ? w3.as = g3.forwardedAs : v3 && !v3(b2, S3) || (w3[b2] = g3[b2])), v3 || false || isPropValid(b2) || Ke.has(b2) || (Ke.add(b2), console.warn('styled-components: it looks like an unknown prop "'.concat(b2, '" is being sent through to the DOM, which will likely trigger a React console error. If you would like automatic filtering of unknown props, you can opt-into that behavior via `<StyleSheetManager shouldForwardProp={...}>` (connect an API like `@emotion/is-prop-valid`) or consider using transient props (`$` prefix for automatic filtering.)')));
      var E2 = function(e4, t, n) {
        var o2 = Ve(), r5 = e4.generateAndInjectStyles(t ? N : n, o2.styleSheet, o2.stylis);
        return (0, import_react.useDebugValue)(r5), r5;
      }(c3, i3, g3);
      !i3 && e3.warnTooManyClasses && e3.warnTooManyClasses(E2);
      var C3 = te(d2, h2);
      return E2 && (C3 += " " + E2), g3.className && (C3 += " " + g3.className), w3[M(S3) && !_.has(S3) ? "class" : "className"] = C3, w3.ref = s3, (0, import_react.createElement)(S3, w3);
    }(R2, e2, r3, O2);
  }
  D2.displayName = y2;
  var R2 = import_react.default.forwardRef(D2);
  return R2.attrs = g2, R2.componentStyle = I2, R2.displayName = y2, R2.shouldForwardProp = S2, R2.foldedComponentIds = i2 ? te(a2.foldedComponentIds, a2.styledComponentId) : "", R2.styledComponentId = v2, R2.target = i2 ? a2.target : e, Object.defineProperty(R2, "defaultProps", { get: function() {
  ...
  } }), b(y2, v2), R2.warnTooManyClasses = function(e2, t) {
    var n = {}, o2 = false;
    return function(r3) {
...
var ut = function() {
  function e() {
    ...
    this._emitSheetCSS = function() {
      var t = e2.instance.toString(), n = Se(), o2 = ne([n && 'nonce="'.concat(n, '"'), "".concat(f, '="true"'), "".concat("data-styled-version", '="').concat("6.0.0-rc.6", '"')].filter(Boolean), " ");
      ...
      if (e2.sealed)
        throw ce(2);
      var r2 = ((n = {})[f] = "", n["data-styled-version"] = "6.0.0-rc.6", n.dangerouslySetInnerHTML = { __html: e2.instance.toString() }, n), s2 = Se();
